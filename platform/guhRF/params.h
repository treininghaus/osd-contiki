...
#define BOOTLOADER_GET_MAC            0  // get mac from booloader, need bootloader bonsai, PARAMETER_STORAGE 0
...
#define PARAMETER_STORAGE 1           // get mac from booloader, need bootloader bonsai, PARAMETER_STORAGE 0
#endif
